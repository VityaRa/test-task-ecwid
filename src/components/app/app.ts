...
export class App extends BaseComponent{
  private adderContainer: BaseComponent = new BaseComponent('header', ['add-field__container'])
  private galaryContainer: BaseComponent = new BaseComponent('div', ['galary-container'])
